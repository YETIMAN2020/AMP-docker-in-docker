...
#
# It publishes:
#     <DOCKERHUB_USERNAME>/amp-dockerized:podman
#     <DOCKERHUB_USERNAME>/amp-dockerized:latest   (same image, for convenience)
#
# Triggers:
    ...
    steps:
      ...
      - name: "Build and Push Podman Variant"
        ...
        with:
          ...
          push: true
          tags: |
            ${{ secrets.DOCKERHUB_USERNAME }}/amp-dockerized:podman
            ${{ secrets.DOCKERHUB_USERNAME }}/amp-dockerized:latest
